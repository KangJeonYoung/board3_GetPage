	...
	<div class="col-lg-12">
		<div class ="panel panel-default">
			...
			<div class="panel-body">
				...
				<form role="form" action="/board/company_modify" method="post">
					<div class="row">
					...
					<button type="button" onclick="location.href='/board/company_remove?bno=${board.bno}'" class ="btn btn-default">삭제</button>
