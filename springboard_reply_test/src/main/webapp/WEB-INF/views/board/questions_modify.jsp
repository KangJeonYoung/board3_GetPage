	...
	<div class="col-lg-12">
		<div class ="panel panel-default">
			...
			<div class="panel-body">
				...
				<form role="form" action="/board/questions_modify" method="post">
					<div class="row">
					...
					<div class="form-group">
						<label>텍스트 내용</label> 
						<textarea class="ckeditor" rows="3" name='content'>
					...
					<button type="button" onclick="location.href='/board/questions_remove?bno=${board.bno}'" class ="btn btn-default">삭제</button>
